...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      ...
      >
        {/* <!-- SIDEBAR HEADER --> */}
        <div className="flex items-center  gap-2 px-9 py-5.5 lg:py-6.5 flex-row">
          <Link href="/">
            <Image
              width={32}
              height={32}
            ...
            <p className={!sidebarOpen ? "block text-white font-bold" : "hidden text-white font-bold"}>OJEK PPOB </p>
          ...
          >
           <AiOutlineAlignLeft size={25} color="#fff" />
          </button> */}
        </div>
        {/* <!-- SIDEBAR HEADER --> */}
